...
Feel free to check the [issues page](https://github.com/Wahaj-Ali/hello-rails-react/issues)
...
This project is [MIT](https://github.com/Wahaj-Ali/hello-rails-react/blob/dev/LICENSE) licensed.
